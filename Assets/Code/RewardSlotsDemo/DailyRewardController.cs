    ...
    public class DailyRewardController
    {
        ...
        private void RefreshUi()
        {
            ...
            if (_isGetReward)
            {
                ...
                _dailyRewardView.GetRewardProgressBar.fillAmount = 1;
            ...
            else
            {
                ...
                if (_dailyRewardView.TimeGetReward != null)
                {
                    ...
                    _dailyRewardView.GetRewardProgressBar.fillAmount = (_dailyRewardView.TimeCooldown - (float)currentClaimCooldown.TotalSeconds) / _dailyRewardView.TimeCooldown;
